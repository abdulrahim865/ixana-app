      ...
      <div className="container mx-auto pt-14 md:pt-28">
        <div className="flex justify-center">
          <div className="flex flex-col w-full lg:max-w-xl gap-10 py-10 px-5 privacy-policy-wrapper">
            ...
            <div>
              <p>Welcome to Ixana, a trademark of Quasistatics Inc.</p>

              <p>
                {`These terms and conditions outline the rules and regulations for the use of Quasistatics Inc.'s Website,
                located at ixana.ai.`}
              </p>

              <p>
                By accessing this website we assume you accept these terms and conditions. Do not continue to use Ixana
            ...
            taken as interchangeable and therefore as referring to same.`}
              ...
              <p>
                {`We employ the use of cookies. By accessing Ixana, you agreed to use cookies in agreement with the
            Quasistatics Inc.'s Privacy Policy.`}{" "}
              </p>
            ...
            website. Some of our affiliate/advertising partners may also use cookies.`}
              ...
              <p>
                Unless otherwise stated, Quasistatics Inc. and/or its licensors own the intellectual property rights for
                all material on Ixana. All intellectual property rights are reserved. You may access this from Ixana for
                your own personal use subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from Ixana</li>
                <li>Sell, rent or sub-license material from Ixana</li>
                <li>Reproduce, duplicate or copy material from Ixana</li>
                <li>Redistribute content from Ixana</li>
              </ul>
              ...
              <p>
                ...
                certain areas of the website. Quasistatics Inc. does not filter, edit, publish or review Comments prior
                to their presence on the website. Comments do not reflect the views and opinions of Quasistatics
                Inc.,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
                views and opinions. To the extent permitted by applicable laws, Quasistatics Inc. shall not be liable
              ...
              <p>
                Quasistatics Inc. reserves the right to monitor all Comments and to remove any Comments which can be
              ...
              <p>
                You hereby grant Quasistatics Inc. a non-exclusive license to use, reproduce, edit and authorize others
            ...
            party's site.`}
              ...
              <p>
                ...
                absence of Quasistatics Inc.; and (d) the link is in the context of general resource information.
              </p>
            ...
            and (c) fits within the context of the linking party's site.`}
              ...
              <p>
                ...
                website, you must inform us by sending an e-mail to Quasistatics Inc.. Please include your name, your
              ...
              <p>
                {`No use of Quasistatics Inc.'s logo or other artwork will be allowed for linking absent a trademark license
            agreement.`}
              </p>
