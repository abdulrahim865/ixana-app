...
export default function HomeTopMainView() {
  ...
  return (
    <div className="flex flex-col  gap-5 p-12 md:flex-row min-h-[600px] md:min-h-[100vh]  mt-14 lg:mt-0 bg-[#F1F1F1] w-full ">
      <div
        className="flex bg-center bg-no-repeat bg-cover basis-[40%] grow rounded-2xl "
      ...
      <div className="flex flex-col items-center justify-center gap-5 md:items-start grow basis-[60%]">
        <div
          className="flex justify-center w-full rounded-2xl grow"
