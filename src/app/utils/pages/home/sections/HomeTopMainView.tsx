...
export default function HomeTopMainView() {
  return (
    ...
    >
      <div className="absolute top-0 bottom-0 left-0 right-0 flex flex-col items-center items-end gap-5 md:flex-row">
        <Image
        ...
        <div className="relative flex flex-col-reverse items-center justify-center h-auto md:items-start basis-1/2 md:flex-col">
          <Image
            ...
            priority
          />
          <h1 className="flex flex-col gap-3 pt-40 text-3xl md:text-8xl">
            <span>Body-internet</span>
            <span className="flex items-center">
              <span>platform</span>
              <Pbutton
                wrapperClass="ml-5 flex"
                text="Try Ixana"
