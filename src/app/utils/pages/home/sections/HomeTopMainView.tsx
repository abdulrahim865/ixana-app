      ...
      <div className="container mx-auto">
        <div className="flex flex-col-reverse gap-5 p-3 md:p-12 md:flex-row min-h-[600px] md:min-h-[80vh]  mt-14 lg:mt-0  md:w-full ">
          <div className="flex flex-col items-center justify-center gap-5 md:items-start grow basis-[30%]">
            <h1 className="flex flex-col items-start justify-center gap-3 text-5xl md:text-7xl lg:basis-3/4 order-1">
            ...
            <div className="flex justify-center w-full rounded-2xl h-[400px] lg:min-h-fit overflow-hidden md:grow order-3 bg-gradient-to-r from-[#312F2F] to-[#74706F]">
              <Image
