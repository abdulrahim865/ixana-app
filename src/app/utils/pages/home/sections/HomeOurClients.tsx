    ...
    <div className="flex min-h-[80vh] w-full flex-col  items-center container justify-center my-12  px-12 lg:px-0">
      <div className="flex flex-col items-center gap-12">
        <div className="flex flex-col items-center gap-3">
          <h2 className="flex text-4xl font-light max-w-[800px] text-center">Our clients</h2>
        </div>
        <div className="flex flex-col items-center gap-5 lg:flex-row">
          {testimonials.map((item) => (
            <div className="flex flex-col items-center gap-5 basis-1/3" key={item.name}>
              <Image src={`/assets/home/${item.icon}`} alt="Booth Button" width={62} height={62} priority />
